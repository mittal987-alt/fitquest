...
final List<GearModel> allGear = [
  ...
  GearModel(
    id: 'titan_greaves',
    name: 'Titan Greaves',
    description: 'Legendary footwear. +10 Endurance, +5 Strength.',
    slot: GearSlot.footwear,
    modifiers: {'endurance': 10.0, 'strength': 5.0, 'step_xp_mult': 1.5},
    price: 10000,
    icon: 'titan_boots',
  ),
  GearModel(
    id: 'overseer_eye',
    name: 'Overseer Eye',
    description: 'Legendary optics. +15% XP and massive bounty range.',
    slot: GearSlot.optics,
    modifiers: {'xp_mult': 1.15, 'bounty_radius': 2.5, 'agility': 5.0},
    price: 12000,
    icon: 'eye_icon',
  ),
  GearModel(
